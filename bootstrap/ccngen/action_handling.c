...
CCNAC_ID_DYNAMIC_GEN_AST, CCNAC_ID_DYNAMIC_START_ENUM_HEADER, CCNAC_ID_DYNAMIC_GENENUM, CCNAC_ID_DYNAMIC_GENENUMVALUES, CCNAC_ID_DYNAMIC_START_TABLE_GEN, CCNAC_ID_DYNAMIC_GENTRAVVTABLE, CCNAC_ID_DYNAMIC_GENTRAVDATASTRUCTS, CCNAC_ID_DYNAMIC_GENPASSTABLE, CCNAC_ID_DYNAMIC_GENSYSTEMTRAVERSALS, CCNAC_ID_DYNAMIC_GENTRAVTABLE, CCNAC_ID_DYNAMIC_GENACTIONSHEADER, CCNAC_ID_DYNAMIC_GENCOPYTRAVERSAL, CCNAC_ID_DYNAMIC_GENFREETRAVERSAL, CCNAC_ID_DYNAMIC_GENCHECKTRAVERSAL, CCNAC_ID_NULL, };
...
CCNAC_ID_SCANANDPARSE, CCNAC_ID_SEMANTIC, CCNAC_ID_DYNAMIC_BACKEND, CCNAC_ID_PHASE_DRIVER, CCNAC_ID_PRINT, CCNAC_ID_NULL, };
