...
struct ccn_node *AITAsetexpr(struct ccn_node *node);
struct ccn_node *AITAsetoperation(struct ccn_node *node);
struct ccn_node *AITAsetoperation(struct ccn_node *node);
struct ccn_node *AITAsetliteral(struct ccn_node *node);
struct ccn_node *AITAsetliteral(struct ccn_node *node);
struct ccn_node *AITAsetreference(struct ccn_node *node);
struct ccn_node *AITAsetreference(struct ccn_node *node);
struct ccn_node *AITAlink(struct ccn_node *node);
struct ccn_node *AITAiphase(struct ccn_node *node);
struct ccn_node *AITAiphase(struct ccn_node *node);
struct ccn_node *AITAipass(struct ccn_node *node);
struct ccn_node *AITAipass(struct ccn_node *node);
struct ccn_node *AITAinode(struct ccn_node *node);
struct ccn_node *AITAinode(struct ccn_node *node);
struct ccn_node *AITAitraversal(struct ccn_node *node);
struct ccn_node *AITAitraversal(struct ccn_node *node);
struct ccn_node *AITAaction(struct ccn_node *node);
struct ccn_node *AITAiphase(struct ccn_node *node);
struct ccn_node *AITAiphase(struct ccn_node *node);
struct ccn_node *AITAipass(struct ccn_node *node);
struct ccn_node *AITAipass(struct ccn_node *node);
struct ccn_node *AITAitraversal(struct ccn_node *node);
struct ccn_node *AITAitraversal(struct ccn_node *node);
struct ccn_node *AITAiunion(struct ccn_node *node);
struct ccn_node *AITAintersect(struct ccn_node *node);
struct ccn_node *AITAdifference(struct ccn_node *node);
struct ccn_node *AITAsetoperation_type(struct ccn_node *node);
struct ccn_node *AITAso(struct ccn_node *node);
struct ccn_node *AITAuser(struct ccn_node *node);
struct ccn_node *AITAlink(struct ccn_node *node);
struct ccn_node *AITAlink_or_enum(struct ccn_node *node);
struct ccn_node *AITAint(struct ccn_node *node);
struct ccn_node *AITAstring(struct ccn_node *node);
struct ccn_node *AITAbool(struct ccn_node *node);
struct ccn_node *AITAint8(struct ccn_node *node);
struct ccn_node *AITAint16(struct ccn_node *node);
struct ccn_node *AITAint32(struct ccn_node *node);
struct ccn_node *AITAfloat(struct ccn_node *node);
struct ccn_node *AITAdouble(struct ccn_node *node);
struct ccn_node *AITAuint(struct ccn_node *node);
struct ccn_node *AITAuint8(struct ccn_node *node);
struct ccn_node *AITAuint16(struct ccn_node *node);
struct ccn_node *AITAuint32(struct ccn_node *node);
struct ccn_node *AITAattribute_type(struct ccn_node *node);
struct ccn_node *AITAat(struct ccn_node *node);
struct ccn_node *AITAinode(struct ccn_node *node);
struct ccn_node *AITAinodeset(struct ccn_node *node);
struct ccn_node *AITAchild_type(struct ccn_node *node);
struct ccn_node *AITAct(struct ccn_node *node);
struct ccn_node *AITAdisallowed(struct ccn_node *node);
struct ccn_node *AITAmandatory(struct ccn_node *node);
struct ccn_node *AITAlifetime_type(struct ccn_node *node);
struct ccn_node *AITAlt(struct ccn_node *node);
