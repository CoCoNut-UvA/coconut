...
struct ccn_node *GDsetexpr(struct ccn_node *node);
struct ccn_node *GDsetliteral(struct ccn_node *node);
struct ccn_node *GDsetliteral(struct ccn_node *node);
struct ccn_node *GDsetreference(struct ccn_node *node);
struct ccn_node *GDsetreference(struct ccn_node *node);
struct ccn_node *GDsetoperation(struct ccn_node *node);
struct ccn_node *GDsetoperation(struct ccn_node *node);
struct ccn_node *GDlink(struct ccn_node *node);
struct ccn_node *GDinode(struct ccn_node *node);
struct ccn_node *GDinode(struct ccn_node *node);
struct ccn_node *GDipass(struct ccn_node *node);
struct ccn_node *GDipass(struct ccn_node *node);
struct ccn_node *GDitraversal(struct ccn_node *node);
struct ccn_node *GDitraversal(struct ccn_node *node);
struct ccn_node *GDiphase(struct ccn_node *node);
struct ccn_node *GDiphase(struct ccn_node *node);
struct ccn_node *GDaction(struct ccn_node *node);
struct ccn_node *GDipass(struct ccn_node *node);
struct ccn_node *GDipass(struct ccn_node *node);
struct ccn_node *GDitraversal(struct ccn_node *node);
struct ccn_node *GDitraversal(struct ccn_node *node);
struct ccn_node *GDiphase(struct ccn_node *node);
struct ccn_node *GDiphase(struct ccn_node *node);
struct ccn_node *GDiunion(struct ccn_node *node);
struct ccn_node *GDintersect(struct ccn_node *node);
...
struct ccn_node *GDstring(struct ccn_node *node);
struct ccn_node *GDbool(struct ccn_node *node);
struct ccn_node *GDint8(struct ccn_node *node);
struct ccn_node *GDint16(struct ccn_node *node);
struct ccn_node *GDint32(struct ccn_node *node);
struct ccn_node *GDfloat(struct ccn_node *node);
struct ccn_node *GDdouble(struct ccn_node *node);
struct ccn_node *GDuint(struct ccn_node *node);
struct ccn_node *GDuint8(struct ccn_node *node);
struct ccn_node *GDuint16(struct ccn_node *node);
struct ccn_node *GDuint32(struct ccn_node *node);
struct ccn_node *GDattribute_type(struct ccn_node *node);
struct ccn_node *GDat(struct ccn_node *node);
struct ccn_node *GDinode(struct ccn_node *node);
struct ccn_node *GDinodeset(struct ccn_node *node);
struct ccn_node *GDchild_type(struct ccn_node *node);
struct ccn_node *GDct(struct ccn_node *node);
