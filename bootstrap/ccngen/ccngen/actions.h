...
struct ccn_node *DGTDTiint(struct ccn_node *node);
struct ccn_node *DGTDTistring(struct ccn_node *node);
struct ccn_node *DGTDTibool(struct ccn_node *node);
struct ccn_node *DGTDTiint8(struct ccn_node *node);
struct ccn_node *DGTDTiint16(struct ccn_node *node);
struct ccn_node *DGTDTifloat(struct ccn_node *node);
struct ccn_node *DGTDTidouble(struct ccn_node *node);
struct ccn_node *DGTDTiuint(struct ccn_node *node);
struct ccn_node *DGTDTinode(struct ccn_node *node);
