...
struct ccn_node *RCBast(struct ccn_node *node);
struct ccn_node *USEid(struct ccn_node *node);
struct ccn_node *USEienum(struct ccn_node *node);
struct ccn_node *USEattribute(struct ccn_node *node);
struct ccn_node *USEitravdata(struct ccn_node *node);
...
struct ccn_node *USEste(struct ccn_node *node);
struct ccn_node *USEchild(struct ccn_node *node);
struct ccn_node *USEinodeset(struct ccn_node *node);
struct ccn_node *USEinode(struct ccn_node *node);
struct ccn_node *USEipass(struct ccn_node *node);
struct ccn_node *USEitraversal(struct ccn_node *node);
struct ccn_node *USEiphase(struct ccn_node *node);
struct ccn_node *USEiactions(struct ccn_node *node);
...
struct ccn_node *DGTDTsetexpr(struct ccn_node *node);
struct ccn_node *DGTDTsetliteral(struct ccn_node *node);
struct ccn_node *DGTDTsetliteral(struct ccn_node *node);
struct ccn_node *DGTDTsetreference(struct ccn_node *node);
struct ccn_node *DGTDTsetreference(struct ccn_node *node);
struct ccn_node *DGTDTsetoperation(struct ccn_node *node);
struct ccn_node *DGTDTsetoperation(struct ccn_node *node);
struct ccn_node *DGTDTlink(struct ccn_node *node);
struct ccn_node *DGTDTinode(struct ccn_node *node);
struct ccn_node *DGTDTinode(struct ccn_node *node);
struct ccn_node *DGTDTipass(struct ccn_node *node);
struct ccn_node *DGTDTipass(struct ccn_node *node);
struct ccn_node *DGTDTitraversal(struct ccn_node *node);
struct ccn_node *DGTDTitraversal(struct ccn_node *node);
struct ccn_node *DGTDTiphase(struct ccn_node *node);
struct ccn_node *DGTDTiphase(struct ccn_node *node);
struct ccn_node *DGTDTaction(struct ccn_node *node);
struct ccn_node *DGTDTipass(struct ccn_node *node);
struct ccn_node *DGTDTipass(struct ccn_node *node);
struct ccn_node *DGTDTitraversal(struct ccn_node *node);
struct ccn_node *DGTDTitraversal(struct ccn_node *node);
struct ccn_node *DGTDTiphase(struct ccn_node *node);
struct ccn_node *DGTDTiphase(struct ccn_node *node);
struct ccn_node *DGTDTiunion(struct ccn_node *node);
struct ccn_node *DGTDTintersect(struct ccn_node *node);
struct ccn_node *DGTDTdifference(struct ccn_node *node);
struct ccn_node *DGTDTsetoperation_type(struct ccn_node *node);
struct ccn_node *DGTDTso(struct ccn_node *node);
struct ccn_node *DGTDTlink(struct ccn_node *node);
struct ccn_node *DGTDTlink_or_enum(struct ccn_node *node);
struct ccn_node *DGTDTint(struct ccn_node *node);
struct ccn_node *DGTDTstring(struct ccn_node *node);
struct ccn_node *DGTDTbool(struct ccn_node *node);
struct ccn_node *DGTDTint8(struct ccn_node *node);
struct ccn_node *DGTDTint16(struct ccn_node *node);
struct ccn_node *DGTDTint32(struct ccn_node *node);
struct ccn_node *DGTDTfloat(struct ccn_node *node);
struct ccn_node *DGTDTdouble(struct ccn_node *node);
struct ccn_node *DGTDTuint(struct ccn_node *node);
struct ccn_node *DGTDTuint8(struct ccn_node *node);
struct ccn_node *DGTDTuint16(struct ccn_node *node);
struct ccn_node *DGTDTuint32(struct ccn_node *node);
struct ccn_node *DGTDTattribute_type(struct ccn_node *node);
struct ccn_node *DGTDTat(struct ccn_node *node);
struct ccn_node *DGTDTinode(struct ccn_node *node);
struct ccn_node *DGTDTinodeset(struct ccn_node *node);
struct ccn_node *DGTDTchild_type(struct ccn_node *node);
struct ccn_node *DGTDTct(struct ccn_node *node);
