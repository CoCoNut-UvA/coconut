...
struct ccn_node *GITsetliteral(struct ccn_node *node);
struct ccn_node *GITsetreference(struct ccn_node *node);
struct ccn_node *GITsetoperation(struct ccn_node *node);
struct ccn_node *GITinode(struct ccn_node *node);
struct ccn_node *GITipass(struct ccn_node *node);
struct ccn_node *GITitraversal(struct ccn_node *node);
struct ccn_node *GITiphase(struct ccn_node *node);
struct ccn_node *GITipass(struct ccn_node *node);
struct ccn_node *GITitraversal(struct ccn_node *node);
struct ccn_node *GITiphase(struct ccn_node *node);
struct ccn_node *GITiunion(struct ccn_node *node);
struct ccn_node *GITintersect(struct ccn_node *node);
struct ccn_node *GITdifference(struct ccn_node *node);
struct ccn_node *GITlink(struct ccn_node *node);
struct ccn_node *GITlink_or_enum(struct ccn_node *node);
struct ccn_node *GITiint(struct ccn_node *node);
struct ccn_node *GITistring(struct ccn_node *node);
struct ccn_node *GITibool(struct ccn_node *node);
struct ccn_node *GITiint8(struct ccn_node *node);
struct ccn_node *GITiint16(struct ccn_node *node);
struct ccn_node *GITifloat(struct ccn_node *node);
struct ccn_node *GITidouble(struct ccn_node *node);
struct ccn_node *GITiuint(struct ccn_node *node);
struct ccn_node *GITinode(struct ccn_node *node);
struct ccn_node *GITinodeset(struct ccn_node *node);
