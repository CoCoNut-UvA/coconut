...
void print_init_compilation_messages(char *header, char *filename, array *lines,
                                     imap_t *parser_locations);

void print_error(void *loc_obj, char *format, ...);
void print_error_at(int lineno, int column, char *line, char *format, ...);
void print_error_range(int lineno, int column_start, int column_end, char *line,
                       char *format, ...);
