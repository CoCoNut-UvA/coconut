...
enum ccn_action_id dynamicgenvisits_ids_table[] = {    CCNAC_ID_DYNAMIC_START_EQUATION_HEADER,     CCNAC_ID_DYNAMICGENEQUATIONINCLUDES,     CCNAC_ID_DYNAMICGENEQUATIONFUNCTIONS,     CCNAC_ID_DYNAMIC_START_VISIT_HEADER,     CCNAC_ID_DYNAMICGENVISITFUNCTIONS,     CCNAC_ID_DYNAMICSWITCHTOVISITSOURCE,     CCNAC_ID_DYNAMICGENVISITSOURCE,     CCNAC_ID_DYNAMIC_START_AG_HEADER,     CCNAC_ID_DYNAMICGENAGHEADER,     CCNAC_ID_DYNAMICSWITCHTOAGSOURCE,     CCNAC_ID_DYNAMICGENAGSOURCE,     CCNAC_ID_NULL, };

enum ccn_action_id dynamicgenast_ids_table[] = {    CCNAC_ID_DYNAMIC_START_AST_HEADER,     CCNAC_ID_DYNAMICGENNODESTRUCTS,     CCNAC_ID_DYNAMICGENNODEMACROS,     CCNAC_ID_DYNAMICGENNODEINITFUNCTIONS,     CCNAC_ID_DYNAMICGENNODEUNION,     CCNAC_ID_DYNAMICGENBASENODE,     CCNAC_ID_DYNAMICGENNODEACCESSFUNCTIONS,     CCNAC_ID_DYNAMICGENNODESETACCESSFUNCTIONS,     CCNAC_ID_DYNAMICSWITCHTOASTSOURCE,     CCNAC_ID_DYNAMICGENBASENODEINIT,     CCNAC_ID_DYNAMICGENNODECONSTRUCTOR,     CCNAC_ID_DYNAMICGENNODEACCESSFUNCTIONSERROR,     CCNAC_ID_DYNAMICGENNODESETACCESSFUNCTIONSERROR,     CCNAC_ID_NULL, };
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENAGSOURCE, "dynamicGenAGSource", .traversal = {TRAV_DGAGS,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENAGHEADER, "dynamicGenAGHeader", .traversal = {TRAV_DGAGH,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENNODESETACCESSFUNCTIONSERROR, "dynamicGenNodesetAccessFunctionsError", .traversal = {TRAV_DGNSAFE,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENNODEACCESSFUNCTIONSERROR, "dynamicGenNodeAccessFunctionsError", .traversal = {TRAV_DGNAFE,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENNODESETACCESSFUNCTIONS, "dynamicGenNodesetAccessFunctions", .traversal = {TRAV_DGNSAF,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENNODEACCESSFUNCTIONS, "dynamicGenNodeAccessFunctions", .traversal = {TRAV_DGNAF,},},
...
{CCN_ACTION_PASS, CCNAC_ID_DYNAMICSWITCHTOAGSOURCE, "dynamicSwitchToAGSource", .pass = {PASS_DYNAMICSWITCHTOAGSOURCE,},},
{CCN_ACTION_PASS, CCNAC_ID_DYNAMIC_START_AG_HEADER, "dynamic_start_ag_header", .pass = {PASS_DYNAMIC_START_AG_HEADER,},},
