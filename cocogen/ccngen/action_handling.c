...
enum ccn_action_id dynamicgenvisits_ids_table[] = {    CCNAC_ID_DYNAMIC_START_VISIT_HEADER,     CCNAC_ID_DYNAMICGENVISITFUNCTIONS,     CCNAC_ID_DYNAMICSWITCHTOVISITSOURCE,     CCNAC_ID_DYNAMICGENVISITSOURCE,     CCNAC_ID_NULL, };
