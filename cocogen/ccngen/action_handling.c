...
enum ccn_action_id dynamicgenuserfiles_ids_table[] = {
CCNAC_ID_DYNAMICUSERGENPASSES, CCNAC_ID_DYNAMICUSERGENTRAVERSALS, CCNAC_ID_NULL, };

enum ccn_action_id dynamicgenast_ids_table[] = {
CCNAC_ID_DYNAMIC_START_AST_HEADER, CCNAC_ID_DYNAMICGENNODESTRUCTS, CCNAC_ID_DYNAMICGENNODEMACROS, CCNAC_ID_DYNAMICGENNODEINITFUNCTIONS, CCNAC_ID_DYNAMICGENNODEUNION, CCNAC_ID_DYNAMICGENBASENODE, CCNAC_ID_DYNAMICSWITCHTOASTSOURCE, CCNAC_ID_DYNAMICGENBASENODEINIT, CCNAC_ID_DYNAMICGENNODECONSTRUCTOR, CCNAC_ID_NULL, };

enum ccn_action_id dynamicgentravdata_ids_table[] = {
CCNAC_ID_DYNAMICSTARTTRAVDATA, CCNAC_ID_DYNAMICGENTRAVDATASTRUCTS, CCNAC_ID_DYNAMICGENTRAVDATAUNION, CCNAC_ID_DYNAMICGENTRAVDATAGETTERS, CCNAC_ID_DYNAMICGENTRAVDATACTORSHEADER, CCNAC_ID_DYNAMICSWITCHTRAVDATA, CCNAC_ID_DYNAMICGENTRAVDATACTORS, CCNAC_ID_NULL, };

enum ccn_action_id staticgenast_ids_table[] = {
CCNAC_ID_STATICGENNODESTRUCTS, CCNAC_ID_NULL, };

enum ccn_action_id staticbackend_ids_table[] = {
CCNAC_ID_STATICGENAST, CCNAC_ID_NULL, };

enum ccn_action_id dynamicbackend_ids_table[] = {
CCNAC_ID_DYNAMICGENAST, CCNAC_ID_DYNAMICSTARTENUMHEADER, CCNAC_ID_DYNAMICGENENUM, CCNAC_ID_DYNAMICGENENUMVALUES, CCNAC_ID_DYNAMICGENTRAVDATA, CCNAC_ID_DYNAMICSTARTTABLEGEN, CCNAC_ID_DYNAMICGENTRAVVTABLE, CCNAC_ID_DYNAMICGENPASSTABLE, CCNAC_ID_DYNAMICGENSYSTEMTRAVERSALS, CCNAC_ID_DYNAMICGENTRAVTABLE, CCNAC_ID_DYNAMICGENTRAVDATATABLES, CCNAC_ID_DYNAMICGENACTIONSHEADER, CCNAC_ID_DYNAMICGENCOPYTRAVERSAL, CCNAC_ID_DYNAMICGENFREETRAVERSAL, CCNAC_ID_DYNAMICGENCHECKTRAVERSAL, CCNAC_ID_DYNAMICGENUSERFILES, CCNAC_ID_DYNAMICGENTRAVFUNCTIONS, CCNAC_ID_NULL, };

enum ccn_action_id phasedriver_ids_table[] = {
CCNAC_ID_GENACTIONARRAYHEADER, CCNAC_ID_GENIDSTABLES, CCNAC_ID_GENACTIONARRAY, CCNAC_ID_GENGATEHEADER, CCNAC_ID_NULL, };

enum ccn_action_id unpacklifetimes_ids_table[] = {
CCNAC_ID_CHECKLIFETIMES, CCNAC_ID_ASSIGNIDTOACTION, CCNAC_ID_MAPIDTOLIFETIME, CCNAC_ID_NULL, };
...
CCNAC_ID_SCANANDPARSE, CCNAC_ID_SEMANTIC, CCNAC_ID_UNPACKLIFETIMES, CCNAC_ID_DYNAMICBACKEND, CCNAC_ID_STATICBACKEND, CCNAC_ID_PHASEDRIVER, CCNAC_ID_GENDOT, CCNAC_ID_GENDEFINES, CCNAC_ID_PRINT, CCNAC_ID_NULL, };
