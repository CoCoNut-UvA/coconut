...
enum ccn_action_id semantic_ids_table[] = {    CCNAC_ID_BUILDSYMBOLTABLE,     CCNAC_ID_CHECKEXISTANCE,     CCNAC_ID_NODESETCHILDTABLE,     CCNAC_ID_UNWRAPSETEXPR,     CCNAC_ID_PROPAGATEATTRIBUTES,     CCNAC_ID_CHECKATTRIBUTES,     CCNAC_ID_CHECKPRODUCTRULES,     CCNAC_ID_REACHABILITY,     CCNAC_ID_NULL, };
