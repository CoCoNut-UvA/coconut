...
node_st *TRAVnext(node_st *node) {
    switch (NODE_TYPE(node)) {
        ...
        case NT_NODESET_CHILD_ENTRY:
            NODESET_CHILD_ENTRY_NEXT(node) = TRAVopt(NODESET_CHILD_ENTRY_NEXT(node));
            break;
            break;
        case NT_ILIFETIME:
        ...
        case NT_ATTRIBUTE:
            ...
            break;
        case NT_EQUATION:
            EQUATION_NEXT(node) = TRAVopt(EQUATION_NEXT(node));
            break;
            break;
        case NT_EQUATION_DEPENDENCY:
        ...
        case NT_VISIT_SEQUENCE_EVAL:
            VISIT_SEQUENCE_EVAL_NEXT(node) = TRAVopt(VISIT_SEQUENCE_EVAL_NEXT(node));
            break;
            break;
        case NT_VISIT_SEQUENCE_VISIT:
            VISIT_SEQUENCE_VISIT_NEXT(node) = TRAVopt(VISIT_SEQUENCE_VISIT_NEXT(node));
            break;
            break;
        case NT_IENUM:
...
node_st *TRAValt(node_st *node) {
    switch (NODE_TYPE(node)) {
        ...
        case NT_VISIT_SEQUENCE_DUMMY:
            VISIT_SEQUENCE_DUMMY_ALT(node) = TRAVopt(VISIT_SEQUENCE_DUMMY_ALT(node));
            break;
            break;
        default:
