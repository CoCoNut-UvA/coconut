...
CCNAC_ID_SCANANDPARSE, CCNAC_ID_SEMANTIC, CCNAC_ID_UNPACK_LIFETIMES, CCNAC_ID_DYNAMIC_BACKEND, CCNAC_ID_PHASE_DRIVER, CCNAC_ID_GEN_DOT, CCNAC_ID_PRINT, CCNAC_ID_GEN_PRINT, CCNAC_ID_NULL, };
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_GEN_PRINT, "gen_print", .traversal = {TRAV_GEN_PRINT,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMIC_USER_GEN_TRAVERSALS, "dynamic_user_gen_traversals", .traversal = {TRAV_DYNAMIC_USER_GEN_TRAVERSALS,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMIC_USER_GEN_PASSES, "dynamic_user_gen_passes", .traversal = {TRAV_DYNAMIC_USER_GEN_PASSES,},},
