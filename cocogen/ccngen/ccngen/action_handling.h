...
enum ccn_action_id {
    ...
    CCNAC_ID_SCHEDULEATTRIBUTEVISITS,
    CCNAC_ID_REACHABILITY,
    CCNAC_ID_CHECKPRODUCTRULES,
    CCNAC_ID_CHECKATTRIBUTES,
    CCNAC_ID_PROPAGATEATTRIBUTES,
    CCNAC_ID_UNWRAPSETEXPR,
    CCNAC_ID_NODESETCHILDTABLE,
    CCNAC_ID_BUILDSYMBOLTABLE,
    CCNAC_ID_CHECKEXISTANCE,
    CCNAC_ID_DYNAMICGENAGSOURCE,
    CCNAC_ID_DYNAMICGENAGHEADER,
    CCNAC_ID_DYNAMICGENVISITSOURCE,
    CCNAC_ID_DYNAMICGENVISITFUNCTIONS,
    CCNAC_ID_DYNAMICGENEQUATIONFUNCTIONS,
    CCNAC_ID_DYNAMICGENEQUATIONINCLUDES,
    CCNAC_ID_DYNAMICGENNODEMACROS,
    CCNAC_ID_DYNAMICGENNODESETACCESSFUNCTIONSERROR,
    CCNAC_ID_DYNAMICGENNODEACCESSFUNCTIONSERROR,
    CCNAC_ID_DYNAMICGENNODESETACCESSFUNCTIONS,
    CCNAC_ID_DYNAMICGENNODEACCESSFUNCTIONS,
    ...
    CCNAC_ID_GENDOT,
    CCNAC_ID_DYNAMICUSERGENEQUATIONS,
    CCNAC_ID_DYNAMICUSERGENTRAVERSALS,
    CCNAC_ID_DYNAMICUSERGENPASSES,
    CCNAC_ID_STATICGENNODESTRUCTS,
    CCNAC_ID_CHILDRENSETMANDATORY,
    CCNAC_ID_MAPIDTOLIFETIME,
    CCNAC_ID_ASSIGNIDTOACTION,
    CCNAC_ID_CHECKLIFETIMES,
    CCNAC_ID_DYNAMICSWITCHTOAGSOURCE,
    CCNAC_ID_DYNAMIC_START_AG_HEADER,
    CCNAC_ID_DYNAMICSWITCHTOVISITSOURCE,
    CCNAC_ID_DYNAMIC_START_VISIT_HEADER,
    CCNAC_ID_DYNAMIC_START_EQUATION_HEADER,
