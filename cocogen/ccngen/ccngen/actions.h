...
struct ccn_node *DGTDSast(struct ccn_node *node);
struct ccn_node *DGTDSast(struct ccn_node *node);
...
struct ccn_node *DGTDUitraversal(struct ccn_node *node);
struct ccn_node *DGT_Fast(struct ccn_node *node);
struct ccn_node *DGT_Fast(struct ccn_node *node);
struct ccn_node *DGT_Finode(struct ccn_node *node);
struct ccn_node *DGT_Finode(struct ccn_node *node);
struct ccn_node *DGT_Fchild(struct ccn_node *node);
struct ccn_node *DGT_Fchild(struct ccn_node *node);
...
struct ccn_node *DUGPast(struct ccn_node *node);
struct ccn_node *SGNSast(struct ccn_node *node);
struct ccn_node *SGNSast(struct ccn_node *node);
struct ccn_node *SGNSinode(struct ccn_node *node);
struct ccn_node *SGNSinode(struct ccn_node *node);
struct ccn_node *SGNSchild(struct ccn_node *node);
struct ccn_node *SGNSchild(struct ccn_node *node);
struct ccn_node *SGNSattribute(struct ccn_node *node);
struct ccn_node *SGNSattribute(struct ccn_node *node);
struct ccn_node *SGNSinodeset(struct ccn_node *node);
struct ccn_node *SGNSinodeset(struct ccn_node *node);
struct ccn_node *SGNSsetliteral(struct ccn_node *node);
struct ccn_node *SGNSsetliteral(struct ccn_node *node);
...
struct ccn_node *AITAiactions(struct ccn_node *node);
struct ccn_node *CLTast(struct ccn_node *node);
struct ccn_node *CLTast(struct ccn_node *node);
struct ccn_node *CLTattribute(struct ccn_node *node);
struct ccn_node *CLTattribute(struct ccn_node *node);
struct ccn_node *dynamicGenBaseNodeInit(struct ccn_node *);
struct ccn_node *dynamicSwitchToAstSource(struct ccn_node *);
struct ccn_node *dynamicGenBaseNode(struct ccn_node *);
struct ccn_node *dynamic_start_ast_header(struct ccn_node *);
struct ccn_node *dynamicSwitchTravData(struct ccn_node *);
struct ccn_node *dynamicStartTravData(struct ccn_node *);
struct ccn_node *dynamicStartTableGen(struct ccn_node *);
struct ccn_node *dynamicStartEnumHeader(struct ccn_node *);
