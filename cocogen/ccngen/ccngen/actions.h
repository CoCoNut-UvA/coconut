...
struct ccn_node *PRTvisit_sequence_dummy(struct ccn_node *node);
struct ccn_node *PRTvisit_sequence_visit(struct ccn_node *node);
struct ccn_node *PRTvisit_sequence_eval(struct ccn_node *node);
struct ccn_node *PRTvisit(struct ccn_node *node);
struct ccn_node *PRTvisit_arg_list(struct ccn_node *node);
...
struct ccn_node *BSTvisit_sequence_dummy(struct ccn_node *node);
struct ccn_node *BSTvisit_sequence_visit(struct ccn_node *node);
struct ccn_node *BSTvisit_sequence_eval(struct ccn_node *node);
struct ccn_node *BSTvisit(struct ccn_node *node);
struct ccn_node *BSTvisit_arg_list(struct ccn_node *node);
...
struct ccn_node *CEXvisit_sequence_dummy(struct ccn_node *node);
struct ccn_node *CEXvisit_sequence_visit(struct ccn_node *node);
struct ccn_node *CEXvisit_sequence_eval(struct ccn_node *node);
struct ccn_node *CEXvisit(struct ccn_node *node);
struct ccn_node *CEXvisit_arg_list(struct ccn_node *node);
...
ccn_node *DGAGSast(ccn_node *);
ccn_node *DGAGSast(ccn_node *);
ccn_node *DGAGSinode(ccn_node *);
ccn_node *DGAGSinode(ccn_node *);
ccn_node *DGAGSvisit(ccn_node *);
ccn_node *DGAGSvisit(ccn_node *);
ccn_node *DGAGHast(ccn_node *);
ccn_node *DGAGHast(ccn_node *);
ccn_node *DGVSast(ccn_node *);
ccn_node *DGVSast(ccn_node *);
ccn_node *DGVSvisit(ccn_node *);
ccn_node *DGVSvisit(ccn_node *);
ccn_node *DGVSvisit_sequence_eval(ccn_node *);
ccn_node *DGVSvisit_sequence_eval(ccn_node *);
ccn_node *DGVSvisit_sequence_visit(ccn_node *);
ccn_node *DGVSvisit_sequence_visit(ccn_node *);
ccn_node *DGVFast(ccn_node *);
ccn_node *DGVFast(ccn_node *);
ccn_node *DGVFvisit(ccn_node *);
ccn_node *DGVFvisit(ccn_node *);
ccn_node *DGEFast(ccn_node *);
ccn_node *DGEFast(ccn_node *);
ccn_node *DGEFinode(ccn_node *);
ccn_node *DGEFinode(ccn_node *);
ccn_node *DGEFequation(ccn_node *);
ccn_node *DGEFequation(ccn_node *);
ccn_node *DGEIast(ccn_node *);
ccn_node *DGEIast(ccn_node *);
ccn_node *DGEIinode(ccn_node *);
ccn_node *DGEIinode(ccn_node *);
...
ccn_node *DGNMattribute(ccn_node *);
ccn_node *DGNMinodeset(ccn_node *);
ccn_node *DGNMinodeset(ccn_node *);
ccn_node *DGNSAFEast(ccn_node *);
ccn_node *DGNSAFEast(ccn_node *);
ccn_node *DGNSAFEinodeset(ccn_node *);
ccn_node *DGNSAFEinodeset(ccn_node *);
ccn_node *DGNSAFEattribute(ccn_node *);
ccn_node *DGNSAFEattribute(ccn_node *);
ccn_node *DGNAFEast(ccn_node *);
ccn_node *DGNAFEast(ccn_node *);
ccn_node *DGNAFEinode(ccn_node *);
ccn_node *DGNAFEinode(ccn_node *);
ccn_node *DGNAFEattribute(ccn_node *);
ccn_node *DGNAFEattribute(ccn_node *);
ccn_node *DGNAFEchild(ccn_node *);
ccn_node *DGNAFEchild(ccn_node *);
ccn_node *DGNSAFast(ccn_node *);
ccn_node *DGNSAFast(ccn_node *);
ccn_node *DGNSAFinodeset(ccn_node *);
ccn_node *DGNSAFinodeset(ccn_node *);
ccn_node *DGNSAFattribute(ccn_node *);
ccn_node *DGNSAFattribute(ccn_node *);
ccn_node *DGNSAFsetliteral(ccn_node *);
ccn_node *DGNSAFsetliteral(ccn_node *);
ccn_node *DGNAFast(ccn_node *);
ccn_node *DGNAFast(ccn_node *);
ccn_node *DGNAFinode(ccn_node *);
ccn_node *DGNAFinode(ccn_node *);
ccn_node *DGNAFattribute(ccn_node *);
ccn_node *DGNAFattribute(ccn_node *);
ccn_node *DGNAFchild(ccn_node *);
ccn_node *DGNAFchild(ccn_node *);
...
ccn_node *DGTAinode(ccn_node *);
ccn_node *DGCTast(ccn_node *);
ccn_node *DGCTast(ccn_node *);
ccn_node *DGCTinode(ccn_node *);
ccn_node *DGCTinode(ccn_node *);
ccn_node *DGCTchild(ccn_node *);
ccn_node *DGCTchild(ccn_node *);
ccn_node *DGCTattribute(ccn_node *);
ccn_node *DGCTattribute(ccn_node *);
...
struct ccn_node *DGFTvisit_sequence_dummy(struct ccn_node *node);
struct ccn_node *DGFTvisit_sequence_visit(struct ccn_node *node);
struct ccn_node *DGFTvisit_sequence_eval(struct ccn_node *node);
struct ccn_node *DGFTvisit(struct ccn_node *node);
struct ccn_node *DGFTvisit_arg_list(struct ccn_node *node);
...
struct ccn_node *DGCHTvisit_sequence_dummy(struct ccn_node *node);
struct ccn_node *DGCHTvisit_sequence_visit(struct ccn_node *node);
struct ccn_node *DGCHTvisit_sequence_eval(struct ccn_node *node);
struct ccn_node *DGCHTvisit(struct ccn_node *node);
struct ccn_node *DGCHTvisit_arg_list(struct ccn_node *node);
...
ccn_node *GDsetliteral(ccn_node *);
ccn_node *DUGEast(ccn_node *);
ccn_node *DUGEast(ccn_node *);
ccn_node *DUGEinode(ccn_node *);
ccn_node *DUGEinode(ccn_node *);
ccn_node *DUGEequation(ccn_node *);
ccn_node *DUGEequation(ccn_node *);
...
ccn_node *SGNSsetliteral(ccn_node *);
ccn_node *CSMast(ccn_node *);
ccn_node *CSMast(ccn_node *);
ccn_node *CSMinode(ccn_node *);
ccn_node *CSMinode(ccn_node *);
ccn_node *CSMchild(ccn_node *);
ccn_node *CSMchild(ccn_node *);
ccn_node *CSMilifetime(ccn_node *);
ccn_node *CSMilifetime(ccn_node *);
...
ccn_node *CLTattribute(ccn_node *);
ccn_node *dynamicSwitchToAGSource(ccn_node *);
ccn_node *dynamic_start_ag_header(ccn_node *);
ccn_node *dynamicSwitchToVisitSource(ccn_node *);
ccn_node *dynamic_start_visit_header(ccn_node *);
ccn_node *dynamic_start_equation_header(ccn_node *);
...
ccn_node *CPYvisit_sequence_dummy(ccn_node *);
ccn_node *DELvisit_sequence_dummy(ccn_node *);
ccn_node *CHKvisit_sequence_dummy(ccn_node *);
ccn_node *CPYvisit_sequence_visit(ccn_node *);
ccn_node *DELvisit_sequence_visit(ccn_node *);
ccn_node *CHKvisit_sequence_visit(ccn_node *);
ccn_node *CPYvisit_sequence_eval(ccn_node *);
ccn_node *DELvisit_sequence_eval(ccn_node *);
ccn_node *CHKvisit_sequence_eval(ccn_node *);
ccn_node *CPYvisit(ccn_node *);
ccn_node *DELvisit(ccn_node *);
ccn_node *CHKvisit(ccn_node *);
ccn_node *CPYvisit_arg_list(ccn_node *);
ccn_node *DELvisit_arg_list(ccn_node *);
ccn_node *CHKvisit_arg_list(ccn_node *);
