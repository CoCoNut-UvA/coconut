...
struct ccn_node *PRTvisit_sequences(struct ccn_node *node);
...
struct ccn_node *BSTvisit_sequences(struct ccn_node *node);
...
struct ccn_node *CEXvisit_sequences(struct ccn_node *node);
...
struct ccn_node *DGCTvisit_sequences(struct ccn_node *node);
...
struct ccn_node *DGFTvisit_sequences(struct ccn_node *node);
...
struct ccn_node *DGCHTvisit_sequences(struct ccn_node *node);
...
ccn_node *CPYvisit_sequences(ccn_node *);
ccn_node *DELvisit_sequences(ccn_node *);
ccn_node *CHKvisit_sequences(ccn_node *);
