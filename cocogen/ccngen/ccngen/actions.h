...
struct ccn_node *DGCTvisit_sequence_visit(struct ccn_node *node);
struct ccn_node *DGCTvisit_sequence_eval(struct ccn_node *node);
struct ccn_node *DGCTvisit(struct ccn_node *node);
struct ccn_node *DGCTvisit_arg_list(struct ccn_node *node);
