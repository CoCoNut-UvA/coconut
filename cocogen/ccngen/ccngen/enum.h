...
enum ccn_traversal_type {
    TRAV_NULL,
    TRAV_PRINT,
    TRAV_SETLITERALCONTAINS,
    TRAV_SETLITERALDIFFERENCE,
    TRAV_SETLITERALINTERSECT,
    TRAV_SETLITERALUNION,
    TRAV_SETLITERALINSERT,
    TRAV_REACHABILITY,
    TRAV_UNWRAPSETEXPR,
    ...
    TRAV_GEN_IDS_TABLES,
    TRAV_GEN_GATE_HEADER,
    TRAV_DYNAMIC_GENTRAVDATATABLES,
    TRAV_GEN_DOT,
    TRAV_DYNAMIC_USER_GEN_TRAVERSALS,
    TRAV_DYNAMIC_USER_GEN_PASSES,
    TRAV_STATIC_GEN_NODE_STRUCTS,
